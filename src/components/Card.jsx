...
const Card = ({image, tittle, description, style, link}) => {
  return (
    <div className={`flex justify-around  ${style} `}>
      <a className='w-[50%] relative group' href={link}> <FaExternalLinkAlt className='hidden absolute group-hover:block z-10 left-32 top-16 text-3xl' /> <img className='  rounded-2xl group-hover:blur-[2px]' src={image} alt="" /></a>
